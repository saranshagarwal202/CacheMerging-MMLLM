...
from evaluation.workers.model_workers import (
    LLaVA, LLaVA_next, LLaVA_oneVision, LLaVA_oneVision_cam, LLaVA_oneVision_Sink
)

name2worker = {
    'llava-v1.5-7b':LLaVA,
    'llava-v1.6-7b': LLaVA_next,
    'llava-onevision-qwen2-7b-ov-hf': LLaVA_oneVision,
    'LLaVA_oneVision_cam': LLaVA_oneVision_cam,
    'LLaVA_oneVision_Sink': LLaVA_oneVision_Sink
}
