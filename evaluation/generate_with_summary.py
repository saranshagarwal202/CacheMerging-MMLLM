...
from evaluation.utils import get_worker_class, MileBenchDataset
...
def parse_args():
    ...
    parser.add_argument('--data_dir', default='datasets/MileBench')
    parser.add_argument('--dataset_name', default='TextNeedleInAHaystack')
    parser.add_argument('--model_name', default='llava-onevision-qwen2-7b-ov-hf')
    parser.add_argument('--output_dir', default='outputs_new_generator')
    ...
    parser.add_argument('--model_configs', default='evaluation/configs/model_configs.yaml')
